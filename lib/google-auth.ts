...
//
// gmail.readonly lets us READ the inbox — used for the daily Focus score, recognizing
// replies, and learning durable facts for briefings. This is a Google *restricted* scope
// (verification + CASA before prod). (R12 T2: gmail.compose was removed with the
// email-drafting feature; readonly is the only Gmail scope we request now.)
export const GMAIL_READONLY_SCOPE = 'https://www.googleapis.com/auth/gmail.readonly';

// The full set we request at consent time. Calendar scopes first (unchanged), then
// gmail.readonly — existing users who granted fewer must re-consent.
export const GOOGLE_SCOPES: string[] = [...CALENDAR_SCOPES, GMAIL_READONLY_SCOPE];
...
// True once the user has granted Gmail read access (inbox signal for briefings/Focus score).
...
// calendar-only user returns [GMAIL_READONLY_SCOPE] → prompt re-auth.
