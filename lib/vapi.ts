...
${isFirstCall ? 'This is the first call, so keep it short and sweet. Around the 5 minute mark, no matter what is being discussed, finish your current sentence and immediately begin closing: "I want to keep today\'s first call short and sweet — we\'ll go deeper tomorrow. I\'ve got everything I need. Have a focused day." Then end the call. Do not let the conversation go past 6 minutes.' : 'Around the 5 minute mark, no matter what is being discussed, finish your current sentence and begin closing the call warmly. Say something like "I\'ve got everything I need — go make today count. Have a focused day." Then end the call. Do not let the conversation go past 6 minutes under any circumstances.'}
