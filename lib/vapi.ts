...
${whoopText ? `\nWHOOP TODAY (real data — if ${firstName} asks about recovery/sleep/strain, state ONLY these numbers; if they ask for data not shown here, say you don't have it on this call, never invent): ${whoopText}\n` : ''}
