...
Always end with warmth and encouragement. This person is building something — remind them of that.`;
  ...
  const payload: Record<string, unknown> = {
    ...
    assistant: VAPI_ASSISTANT_ID ? undefined : {
      ...
      tools: [
        { type: 'function', messages: [], function: { name: 'readCalendar', description: 'Read calendar events for a date range.', parameters: { type: 'object', properties: { startDate: { type: 'string' }, endDate: { type: 'string' } }, required: ['startDate', 'endDate'] } }, server: { url: `${process.env.NEXT_PUBLIC_APP_URL || 'https://www.edg3.ai'}/api/vapi/tool-call` } },
        { type: 'function', messages: [], function: { name: 'createEvent', description: 'Create a new calendar event.', parameters: { type: 'object', properties: { title: { type: 'string' }, startDateTime: { type: 'string' }, endDateTime: { type: 'string' }, timezone: { type: 'string' }, color: { type: 'string' } }, required: ['title', 'startDateTime', 'endDateTime', 'timezone'] } }, server: { url: `${process.env.NEXT_PUBLIC_APP_URL || 'https://www.edg3.ai'}/api/vapi/tool-call` } },
        { type: 'function', messages: [], function: { name: 'deleteEvent', description: 'Delete a calendar event by title and date.', parameters: { type: 'object', properties: { title: { type: 'string' }, date: { type: 'string' }, deleteAll: { type: 'boolean' }, recurringScope: { type: 'string' } }, required: ['title', 'date'] } }, server: { url: `${process.env.NEXT_PUBLIC_APP_URL || 'https://www.edg3.ai'}/api/vapi/tool-call` } },
        { type: 'function', messages: [], function: { name: 'moveEvent', description: 'Move a calendar event to a new time.', parameters: { type: 'object', properties: { title: { type: 'string' }, date: { type: 'string' }, newStartDateTime: { type: 'string' }, newEndDateTime: { type: 'string' }, timezone: { type: 'string' }, recurringScope: { type: 'string' } }, required: ['title', 'date', 'newStartDateTime', 'newEndDateTime', 'timezone'] } }, server: { url: `${process.env.NEXT_PUBLIC_APP_URL || 'https://www.edg3.ai'}/api/vapi/tool-call` } },
        { type: 'function', messages: [], function: { name: 'colorEvent', description: 'Change the color of calendar events.', parameters: { type: 'object', properties: { title: { type: 'string' }, date: { type: 'string' }, color: { type: 'string' } }, required: ['title', 'date', 'color'] } }, server: { url: `${process.env.NEXT_PUBLIC_APP_URL || 'https://www.edg3.ai'}/api/vapi/tool-call` } },
        { type: 'function', messages: [], function: { name: 'createRecurringEvent', description: 'Create a recurring calendar event.', parameters: { type: 'object', properties: { title: { type: 'string' }, startTime: { type: 'string' }, endTime: { type: 'string' }, timezone: { type: 'string' }, startDate: { type: 'string' }, endDate: { type: 'string' }, recurrence: { type: 'string' }, color: { type: 'string' } }, required: ['title', 'startTime', 'endTime', 'timezone', 'startDate', 'recurrence'] } }, server: { url: `${process.env.NEXT_PUBLIC_APP_URL || 'https://www.edg3.ai'}/api/vapi/tool-call` } },
        { type: 'function', messages: [], function: { name: 'planWeek', description: 'Plan the week with focus blocks aligned to priorities.', parameters: { type: 'object', properties: { weekStartDate: { type: 'string' }, focusHoursPerDay: { type: 'number' }, preferences: { type: 'string' } }, required: ['weekStartDate'] } }, server: { url: `${process.env.NEXT_PUBLIC_APP_URL || 'https://www.edg3.ai'}/api/vapi/tool-call` } },
      ],
