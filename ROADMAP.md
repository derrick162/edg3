...
| 🎨 Design | `design` | _(🔨 **A11y + error states running**: focus rings fixed, Activity error state, memory polish. 1407 green. Next: mobile QA pass.)_ | `app/globals.css`, `app/dashboard/page.tsx` | 2026-06-18 |
