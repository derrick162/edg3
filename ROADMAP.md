...
|---|---|---|---|---|
| 🛠️ Core | `core` | _(idle — ✅ `cleanupDuplicates` tool + meal-time awareness SHIPPED. 450/450 green. ⚠️ PM: create Vapi tool + paste UUID — see changelog.)_ | `lib/eventMatch.ts`, `route.ts`, `lib/vapi.ts` | 2026-06-13 |
