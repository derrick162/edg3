...
| 🎨 Design | `design` | _(✅ **Full branding sweep + pillar pass merged to master**: T2 Activity tab inbox receipt copy; comprehensive Edge→Edg3 sweep across `app/dashboard/page.tsx` + all 13 `components/ui/` files — zero remaining bare "Edge" in user-visible strings. T3-1 Memory tab fact categories verified complete. DC3/DC4 gated (Phase 2). M4-3b gated on Core `fact_history` table. Awaiting next PM dispatch.)_ | `app/dashboard/page.tsx`, `components/ui/**`, `app/page.tsx` | 2026-06-18 |
