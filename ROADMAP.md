...
| 🎨 Design | `design` | _(✅ **M4-3b shipped**: "updated [date]" per-fact stamp in Memory tab — `getLatestTimestamps` bulk query, `last_updated_at` on Fact, FactRow + people-section updated. 1803 green.)_ | `app/dashboard/page.tsx`, `app/api/memory/route.ts`, `lib/db.ts` | 2026-06-18 |
