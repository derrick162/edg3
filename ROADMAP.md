...
| 🎨 Design | `design` | _(idle — ✅ **ActivationCard wired + onboarding a11y**: ActivationCard now renders in home tab (pre-first-briefing, /api/learned isFresh gate); onboarding form htmlFor/id pairs for call-time, timezone, phone, summary textarea. 1353 green. Awaiting PM dispatch.)_ | `app/dashboard/page.tsx`, `app/onboarding/page.tsx` | 2026-06-18 |
