...
| 🔒 Security | `security` | _(✅ **Email signal primitive** — `getRecentEmailSignal` in `lib/gmail.ts`. 651/651 green. ⚠️ CASA flag raised in `specs/google-verification.md` — gmail.readonly use-case expanded. PM decision needed on separate consent step. Awaiting PM.)_ | `lib/gmail.ts`, `lib/gmail.test.ts`, `specs/google-verification.md` | 2026-06-14 |
