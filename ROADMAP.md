...
| 🎨 Design | `design` | _(✅ **D24 SHIPPED.** Call history UI: search, pagination (20/page), key moment pills (📅/✓/💡), one-line briefing summary per row. 2326 green. → D25 next.)_ | `app/dashboard/page.tsx` | 2026-06-24 |
