...
|---|---|---|---|---|
| 🛠️ Core | `core` | _(🔨 **R14 ALL 6 SHIPPED (1986 green, ready for PM merge); R15 IN PROGRESS** — calendar intelligence T1–T7 (searchEvents, checkConflict, setEventReminder, blockFocusTime, getNextEvents, briefEvent, generateWeeklyReview). Building per-ticket in `tool-call/route.ts` + `lib/vapi.ts` + pure helpers; preflight+commit each. ⚠️ R14 external Vapi-tool creation still pending PM.)_ | `app/api/vapi/tool-call/route.ts`, `lib/vapi.ts`, `lib/time.ts` | 2026-06-20 |
