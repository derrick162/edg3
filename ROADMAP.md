...
| 🎨 Design | `design` | _(idle — ✅ **Memory moat surface COMPLETE**: Relationship profile cards (person facts grouped by entity into cards with avatar + last-updated), correction micro-reward ("✓ Edge updated" flash after save), patterns placeholder (dashed section, auto-hides when Core ships M3 data), memory tab header reframe ("built from calls, not filled out by hand"). 1331 green. Awaiting PM dispatch.)_ | `app/dashboard/page.tsx` | 2026-06-18 |
