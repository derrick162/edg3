...
| 🎨 Design | `design` | _(🔨 **Mobile QA + a11y done**: landing px-4, touch targets ≥44px, auth card padding, onboarding grid stack, focus rings. 1407 green. Next: design-system consolidation.)_ | `app/page.tsx`, `app/login/**`, `app/signup/**`, `app/onboarding/**`, `app/globals.css` | 2026-06-18 |
