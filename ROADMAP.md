...
| 🎨 Design | `design` | _(✅ **All R8 dispatches + Esther Memory overhaul + landing page T1–T5 SHIPPED (1945 green).** Landing page fully redesigned (Ramp-level polish, imagery, icons, whitespace, branding). Memory tab decluttered (self-filtered, sections reordered, placeholders removed). FocusScoreboard + People section polished. Idle — awaiting R9 dispatch.)_ | — | 2026-06-19 |
