...
| 🎨 Design | `design` | _(idle — ✅ **ContentSection real copy + reader** (`3de59e3`): all 6 Esther cards wired with real titles/previews/bodies; article reader modal on tap. Preflight clean. Awaiting PM.)_ | — | 2026-06-15 |
