...
|---|---|---|---|---|
| 🛠️ Core | `core` | _(✅ **Round 8 SHIPPED (1909 green).** M4-4 social mental models + Briefing V2 proactive wins. Bug fixes pending: empty focus card + event classifier. Awaiting next dispatch.)_ | `lib/briefing.ts`, `lib/facts.ts`, `lib/vapi.ts`, `lib/alignment.ts` | 2026-06-19 |
