...
|---|---|---|---|---|
| 🛠️ Core | `core` | _(✅ **Whoop Intelligence COMPLETE (988 green)**: all 5 sub-items shipped — personal baselines (30d rolling avg + deviation note), overreaching flag + sleep-debt quantity, Whoop→calendar concrete action, deeper correlations (high-strain pattern + tomorrow hint), coaching on call. Also shipped: Support backend, Memory Salience layer, Focus actionable. Awaiting PM dispatch.)_ | — | 2026-06-16 |
