...
|---|---|---|---|---|
| 🛠️ Core | `core` | _(✅ **T4 COMPLETE (1246 green)**: STT transcript canonicalization — `canonicalNamesFromProfile` helper; grounding applied to 3 write paths: stored transcript, call-summary Haiku pass (with calendar event titles), and call-notes memory. Awaiting PM dispatch.)_ | `lib/grounding.ts`, `app/api/vapi/webhook/route.ts`, `lib/briefing.ts` | 2026-06-18 |
