...
| 🎨 Design | `design` | _(🔧 **R11 in progress.** T1: Focus Score hours label. T2: Weekend Focus Brief card. T3: Activity dedup fix.)_ | `app/dashboard/page.tsx`, `components/ui/FocusRecommendationCard.tsx`, `lib/activityLabels.ts` | 2026-06-20 |
