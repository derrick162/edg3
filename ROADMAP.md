...
| 🎨 Design | `design` | _(idle — ✅ **Memory declutter + content section** (`b7a59bd`): Memory tab collapsible categories + tighter rows; ContentSection horizontal scroll row on home tab. Preflight clean. Awaiting PM.)_ | — | 2026-06-15 |
