...
| 🎨 Design | `design` | _(🔄 **Reconciling + new dispatch (hero prominence + D + E)**: merging master a537f73. D+E already committed locally. Now working on DayPlanCard prominence pass.)_ | `app/dashboard/page.tsx`, `components/ui/DayPlanCard.tsx`, `components/ui/EdgeScoreCard.tsx`, `app/globals.css` | 2026-06-17 |
