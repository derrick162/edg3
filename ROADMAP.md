...
| 🎨 Design | `design` | _(✅ **R8 T1+T2 SHIPPED — FocusScoreboard hours bar + tab reorder. T3 (Memory People polish) deferred pending Core schema.** Idle — awaiting dispatch.)_ | `components/ui/FocusScoreboard.tsx`, `app/dashboard/page.tsx` | 2026-06-19 |
