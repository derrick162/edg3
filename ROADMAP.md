...
| 🎨 Design | `design` | _(idle — ✅ **T1+T2/T3 COMPLETE**: Activity dedup (×N badge) + inbox receipt panel; saveFact clears verify flag. 2 commits. ⚠️ `git push --force origin design` still needed — Derrick must run manually.)_ | `app/dashboard/page.tsx` | 2026-06-17 |
