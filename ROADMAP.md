...
|---|---|---|---|---|
| 🛠️ Core | `core` | _(idle — ✅ **PM dispatch COMPLETE** (733 green): Focus Score now reads confirmed daily_focus + getMostRecent fallback; Energy Score calibrating on empty events (no fake 100); priorities → Memory sync (`source='priority-sync'` facts); energy-cost UI removed from Priorities tab. Awaiting PM for next dispatch.)_ | — | 2026-06-15 |
