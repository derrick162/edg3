...
|---|---|---|---|---|
| 🛠️ Core | `core` | _(📋 **R39 + R36 + R37 + R38 dispatched 2026-06-24. R39 is FIRST (blocking bugs): transcript truncation 2k→8k + person category missing "friend" + rememberPreference missing 'person' in VALID_FACT_CATS. Then R36 → R37 → R38.**)_ | `lib/facts.ts`, `app/api/vapi/tool-call/route.ts`, `lib/vapi.ts`, `app/api/memory/notes/route.ts`, `app/dashboard/page.tsx`, `lib/gmail.ts`, `lib/briefing.ts` | 2026-06-24 |
