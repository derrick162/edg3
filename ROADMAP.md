...
| 🎨 Design | `design` | _(idle — ✅ EdgeScore Intelligence score + Energy copy COMPLETE (`75712c0`): 3rd breakdown panel 'Intelligence' (achievements=green ✓, nudges=accent CTA chips); Energy copy → 'how energized you are — blend of sleep + recovery this week'; CalendarFit.intelligenceScore? added. Core: populate intelligenceScore from /api/scores. 759/759 green. Awaiting PM.)_ | — | 2026-06-15 |
