...
| 🎨 Design | `design` | _(✅ **D28 SHIPPED.** Accessibility pass: tablist/tab/main roles, aria-label on all icon-only buttons, global focus-visible ring confirmed. 2326 green. → D29 next.)_ | `app/dashboard/page.tsx`, `ROADMAP-DESIGN.md` | 2026-06-24 |
