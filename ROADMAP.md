...
| 🎨 Design | `design` | _(🔄 **R23 SHIPPED. Now on R22.** R23: sidebar cleanup + sparkline fix shipped. Starting R22 T1: briefings date grouping + transcript polish.)_ | `app/dashboard/page.tsx`, `components/ui/EdgeScoreCard.tsx` | 2026-06-23 |
