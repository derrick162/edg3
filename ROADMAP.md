...
| 🔒 Security | `security` | _(✅ **DATA CONSENT + CASA COMPLETE (1267 green)**: User interface + export payload forward-compat for `data_consent` column (Core adds column). Sentinel comments in briefing/facts/outreach LLM paths. Full CASA section in security-audit.md — two-setting table, data-flow inventory, enforcement state, CASA/Google OAuth checklist. Awaiting PM dispatch.)_ | — | 2026-06-18 |
