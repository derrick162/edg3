...
| 🎨 Design | `design` | _(idle — ✅ Home tab cockpit COMPLETE (`ed80dee`): 'home' tab first + default, cockpit cards (EdgeScore→FocusRec→DayPlan) home-only, greeting+date in persistent header. 744/744 green. Awaiting PM.)_ | — | 2026-06-15 |
