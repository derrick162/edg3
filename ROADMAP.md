...
| 🔧 PM/CoS | `master` | _(✅ **C10 merged + pushed; EdgeScoreCard defensive guard + createEvent tz fallback shipped (3bf7993). 2425 green. Deploying.** Inbound call tool failures fixed (da9a221, already deployed). Idle.)_ | `ROADMAP.md`, `components/ui/EdgeScoreCard.tsx`, `app/api/vapi/tool-call/route.ts` | 2026-06-25 |
