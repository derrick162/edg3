...
| 🎨 Design | `design` | _(🔧 **IN PROGRESS — T2 expandable inbox receipts + merge conflict resolution**: resolved dashboard conflict with Core's emailSubjects/handleExpandItem; enhanced receipt panel with flagged subjects, footer privacy line, max-10+overflow. Preflight running.)_ | `app/dashboard/page.tsx` | 2026-06-18 |
