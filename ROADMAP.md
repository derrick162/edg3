...
| 🎨 Design | `design` | _(idle — ✅ **Status Board idle + changelog**: a11y pass (nav aria-labels, auth htmlFor/id, autoComplete); tsc type fix for Help tab; 1353 green. Awaiting PM dispatch.)_ | `app/dashboard/page.tsx`, `app/login/page.tsx`, `app/signup/page.tsx` | 2026-06-18 |
