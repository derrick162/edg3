...
| 🔒 Security | `security` | _(✅ **Round 8 DONE (1898 green).** `people_models` schema + `peopleModelQueries` shipped. `setEnergyLevel` already existed. Idle — awaiting dispatch.)_ | `lib/db.ts`, `lib/people-models.test.ts` | 2026-06-19 |
