...
| 🎨 Design | `design` | _(✅ **D27 SHIPPED.** PWA: manifest.json, layout.tsx meta tags, dashboard install banner. 2326 green. → D28 next.)_ | `public/manifest.json`, `app/layout.tsx`, `app/dashboard/page.tsx` | 2026-06-24 |
