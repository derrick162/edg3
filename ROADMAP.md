...
| 🎨 Design | `design` | _(working — **ACTIVATION POLISH** + backlog. Merged `a3053cb`. Polishing reveal (Esther's copy, real PlanChange shape, ThinDataFallback Screen 3b, Screen 7 arrival banner). Next: mobile onboarding pass, remaining a11y.)_ | `app/onboarding/page.tsx`, `components/ui/ActivationReveal.tsx`, `components/ui/ActivationHeroCard.tsx`, `app/dashboard/page.tsx` | 2026-06-17 |
