...
| 🎨 Design | `design` | _(✅ **R20 + R19 SHIPPED.** Language selector (English/廣東話 pills) between Morning ritual and Profile; daily quote toggle + theme input inside Morning ritual (visible only when gratitude mode on). tsc + build clean. All dispatch exhausted. Idle.)_ | `app/settings/page.tsx` | 2026-06-22 |
