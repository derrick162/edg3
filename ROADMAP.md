...
| 🔒 Security | `security` | _(✅ **PILLAR-TRUST T1-4 COMPLETE — encryption audit + coverage map**: all 28 tables audited, 14 confirmed encrypted, 3 accepted gaps documented with rationale, full map written to `content/data-protection.md`. Prev: T1-1+T1-3 dead-letter + job failure logging. Awaiting PM merge.)_ | `content/data-protection.md`, `ROADMAP-SECURITY.md` | 2026-06-18 |
