...
|---|---|---|---|---|
| 🛠️ Core | `core` | _(🔨 **R36 SHIPPED (2273 green); R37 + R38 IN PROGRESS.** R37: social mental models — `updatePeopleModels` (sleep-time, fire-and-forget) + `PEOPLE CONTEXT` briefing block. R38: consolidation `(unknown)` entity resolution + event-as-entity guard. ⚠️ Additive to `lib/facts.ts`, `lib/briefing.ts`; `people_models` table is Vijay's (read/write helpers).)_ | `lib/facts.ts`, `lib/briefing.ts` | 2026-06-24 |
