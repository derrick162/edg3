...
| 🎨 Design | `design` | _(idle — ✅ **Landing page Edge Score preview**: inline product mockup (SVG arc gauge + 4 component bars + sparkline + diagnosis chip) in "One number" section; ActivationCard wired; onboarding a11y. 1353 green. Awaiting PM dispatch.)_ | `app/page.tsx` | 2026-06-18 |
