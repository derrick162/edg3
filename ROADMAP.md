...
| 🎨 Design | `design` | _(idle — ✅ **Dispatch D COMPLETE — Edge Score spark**: radial 8-particle spark burst + celebrate-glow on Arc Gauge fires when focus-confirm raises the score. Refetches /api/scores; only celebrates on rise. prefers-reduced-motion honored. 1353 green. Awaiting PM dispatch.)_ | `components/ui/EdgeScoreCard.tsx`, `app/dashboard/page.tsx` | 2026-06-18 |
