...
|---|---|---|---|---|
| 🛠️ Core | `core` | _(✅ **Gmail-link→facts trigger SHIPPED + merged to master (1951 green).** `/api/learned?source=gmail-connect` forces fact-extraction past the thin-facts gate; dashboard calls it on `?gmail_linked=1`. Fixes "no new facts after linking Gmail." Awaiting R8 P0 bugs dispatch.)_ | `app/api/learned/route.ts`, `app/dashboard/page.tsx` | 2026-06-19 |
