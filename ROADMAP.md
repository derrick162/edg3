...
| 🔒 Security | `security` | _(✅ **INTEGRATION TEST SWEEP + BACKUP BUG FIX (1253 green)**: Signup tests (18) — bcrypt DoS cap + input-validation. Backup route tests (14) — auth + path-traversal rejection. Backup lib tests (7) — path traversal neutralization + no-throw. Bug fix: backup filename regex now matches actual ISO8601 format. Activation review (13): derive/accept PASS. All 56 test files, 1253 green. Awaiting PM dispatch.)_ | — | 2026-06-17 |
