...
|---|---|---|---|---|
| 🛠️ Core | `core` | _(✅ **NIGHT-QUEUE COMPLETE (1246 green, preflight clean)**: T4 STT transcript canonicalization (3 write paths); Trust Bug T2 — event-title spelling preferred in fact extraction; T1 fact-correction API (already shipped); T3 score changelog/scoreBefore (already shipped); loading timing + changelog entries. Awaiting PM merge.)_ | — | 2026-06-18 |
