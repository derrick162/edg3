...
|---|---|---|---|---|
| 🛠️ Core | `core` | _(idle — ✅ Dedup `recipientsFromNotes` DONE (80/80, tsc clean). Inline copy removed from route.ts; canonical export from lib/outreach now used everywhere.)_ | — | 2026-06-10 |
