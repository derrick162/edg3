...
|---|---|---|---|---|
| 🛠️ Core | `core` | _(✅ **NIGHT-QUEUE COMPLETE (1246 green)**: T4 STT transcript canonicalization (3 write paths — Derek→Derrick / Jim→Gym); Trust Bug T2 — event-title spelling preferred in fact extraction; activation flow wired to REAL derive data; gym→weight-goal credit in briefing alignment. Awaiting PM dispatch.)_ | — | 2026-06-18 |
