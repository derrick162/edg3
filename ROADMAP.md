...
| 🔧 PM/CoS | `master` | _(📋 **R23 (Core) + R18 (Security) + R21 (Design) dispatched 2026-06-22 — rich open call memory + inbound call support. ⚠️ Derrick (external): In Vapi dashboard, point the Twilio phone number's inbound webhook to `https://www.edg3.ai/api/vapi/webhook`. Also still pending: `recordGratitude` Vapi tool creation + UUID paste.)_ | `ROADMAP.md`, `ROADMAP-CORE.md`, `ROADMAP-SECURITY.md`, `ROADMAP-DESIGN.md` | 2026-06-22 |
