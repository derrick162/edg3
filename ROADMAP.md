...
|---|---|---|---|---|
| 🛠️ Core | `core` | _(✅ **VOICE PREFERENCE (1480 green, preflight clean)**: VOICES map + initiateCall voicePref param (inline + assistantOverrides). DB migration + setVoicePreference. Profile GET/POST extended. Dashboard voice selector in ProfileTab. Previous: Memory Trust Fix, Briefing V2. Awaiting PM merge.)_ | `lib/vapi.ts`, `lib/vapi.test.ts`, `lib/db.ts`, `lib/scheduler.ts`, `app/api/profile/route.ts`, `app/dashboard/page.tsx` | 2026-06-18 |
