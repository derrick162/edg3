...
| 🔒 Security | `security` | _(✅ **DISPATCH S1–S4 DONE (2376 green) — ready for merge.** S1 e2e suite · S2 health push · S3 multi-user audit · S4 OWASP sweep: SQLi clean, auth coverage clean, input-validation audited + fixed subscribe length caps; documented in security-audit.md. Next: S5 (perf benchmarks).)_ | `app/api/notifications/subscribe/route.ts`, `content/security-audit.md` | 2026-06-24 |
