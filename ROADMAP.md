...
|---|---|---|---|---|
| 🛠️ Core | `core` | _(✅ **MEMORY TRUST FIX (1425 green, preflight clean)**: People/goals hallucination guards — isAssistantEntity, isActivityEntity, M2 cross-check, fuzzy entity dedup, cleanupPeopleFacts, tighter extraction prompt, email path guards, dashboard JSX fix. Previous: Briefing V2, M5 Episode Store. Awaiting PM merge.)_ | `lib/facts.ts`, `lib/facts.test.ts`, `app/dashboard/page.tsx`, `ROADMAP-CORE.md` | 2026-06-18 |
