...
| 🎨 Design | `design` | _(idle — ✅ **CASA data consent COMPLETE**: DataConsentScreen (onboarding step) + DataConsentToggle (Settings panel) built and wired. `components/ui/DataConsentCard.tsx` new; `app/onboarding/page.tsx` + `app/dashboard/page.tsx` updated. 1200 green. Awaiting PM dispatch.)_ | `components/ui/DataConsentCard.tsx`, `app/onboarding/page.tsx`, `app/dashboard/page.tsx` | 2026-06-18 |
