...
| 🎨 Design | `design` | _(idle — ✅ **T1+T2/T3 COMPLETE**: Activity dedup (×N badge) + inbox receipt panel; saveFact clears verify flag. Ready to push.)_ | `app/dashboard/page.tsx` | 2026-06-17 |
