...
| 🎨 Design | `design` | _(idle — ✅ **Full queue complete**: memory M2/M3/M4 polish, a11y focus rings, Activity error state, mobile QA (landing/auth/onboarding), design-system utility classes. 1407 green. Awaiting PM dispatch.)_ | — | 2026-06-18 |
