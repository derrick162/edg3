...
| 🎨 Design | `design` | _(✅ **D25 SHIPPED.** Skeletons + empty states: activity 5-row .skeleton, memory empty state copy, Whoop sidebar nudge when disconnected. 2326 green. → D26 next.)_ | `app/dashboard/page.tsx` | 2026-06-24 |
