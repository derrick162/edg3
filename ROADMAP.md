...
| 🎨 Design | `design` | _(idle — ✅ **Memory moat ROUND 2 COMPLETE**: "Recently learned" feed (newest 5 facts, accent border, makes accumulation visible after every call); briefings loading skeleton; Fact type fix. 1331 green. Awaiting PM dispatch.)_ | `app/dashboard/page.tsx` | 2026-06-18 |
