    ...
    <div className="min-h-screen relative" style={{ background: 'var(--background)' }}>
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-8 py-16">
        ...
        <div className="space-y-12">
          ...
          <section className="glass-card p-8 space-y-4" style={{ borderColor: 'rgba(99,102,241,0.2)' }}>
            <h2 className="text-lg font-bold" style={{ color: '#818cf8' }}>What Edg3 Does</h2>
            <p className="text-sm leading-relaxed" style={{ color: '#c8c8d8' }}>
              Edg3 (the "Service") is an AI Chief of Staff that delivers a personalized daily briefing via outbound voice call.
          ...
          <section className="glass-card p-8 space-y-4" style={{ borderColor: 'rgba(99,102,241,0.3)', background: 'rgba(99,102,241,0.04)' }}>
            <h2 className="text-lg font-bold" style={{ color: '#818cf8' }}>Consent to Receive Calls</h2>
            <p className="text-sm leading-relaxed" style={{ color: '#c8c8d8' }}>
              By creating an account and entering your phone number, <strong style={{ color: '#e8e8f0' }}>you expressly consent</strong> to
          ...
          <section className="glass-card p-8 space-y-4">
            <h2 className="text-lg font-bold" style={{ color: '#818cf8' }}>How to Opt Out</h2>
            <p className="text-sm leading-relaxed" style={{ color: '#c8c8d8' }}>
          ...
          <section className="glass-card p-8 space-y-4">
            <h2 className="text-lg font-bold" style={{ color: '#818cf8' }}>Information We Collect</h2>
            <ul className="space-y-2 text-sm" style={{ color: '#c8c8d8' }}>
              {[
          ...
          <section className="glass-card p-8 space-y-4">
            <h2 className="text-lg font-bold" style={{ color: '#818cf8' }}>How We Use Your Information</h2>
            <p className="text-sm leading-relaxed" style={{ color: '#c8c8d8' }}>
          ...
          <section className="glass-card p-8 space-y-4">
            <h2 className="text-lg font-bold" style={{ color: '#818cf8' }}>Data Retention &amp; Deletion</h2>
            <p className="text-sm leading-relaxed" style={{ color: '#c8c8d8' }}>
          ...
          <section className="glass-card p-8 space-y-4">
            <h2 className="text-lg font-bold" style={{ color: '#818cf8' }}>Contact</h2>
            <p className="text-sm leading-relaxed" style={{ color: '#c8c8d8' }}>
