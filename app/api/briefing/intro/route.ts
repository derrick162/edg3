...
Write all numbers as words. Natural spoken language only. No bullet points or formatting — flowing speech. IMPORTANT: Always write your name as "Edge" — never "Edg3".
  ...
  const payload = {
    ...
    assistant: {
      ...
      model: {
        provider: 'anthropic',
        model: 'claude-haiku-4-5-20251001',
        systemPrompt: `You are Edge, an AI Chief of Staff. You just delivered your intro message to ${firstName}. If they respond, acknowledge warmly in one sentence then say "I'll see you tomorrow morning." and end the call. Keep the entire call under 60 seconds. Always refer to yourself as "Edge" — never "Edg3".`,
      },
      firstMessage,
      endCallPhrases: ["I'll see you tomorrow morning", 'see you tomorrow', 'goodbye'],
      // Match the daily call's noise tuning so background noise doesn't cut Edge off.
