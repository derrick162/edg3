...
## Changelog
- **2026-07-02** — **S9 — production DB schema-drift repair (2446 green). URGENT — PM cross-session dispatch.** _(synced master first; committed local on `security`, awaiting PM merge + deploy)_
